...
# 2. 'Misc' 상위 메뉴 정의
class CONSOLE_MT_misc_menu( bpy.types.Menu ):
    bl_label = "Misc"
    bl_idname = "CONSOLE_MT_misc_menu"
...
def draw_misc_top_level( self, context ):
    ...
    layout.menu( CONSOLE_MT_misc_menu.bl_idname, text="Misc" )


# 4. 등록 및 해제
classes = (
    SIMPLE_OT_print_hello,
    CONSOLE_MT_misc_menu,
)
...
def register():
    ...
    bpy.types.CONSOLE_HT_header.append( draw_misc_top_level )

def unregister():
    # VIEW3D 상단 메뉴바에서 Misc 제거
    # bpy.types.VIEW3D_MT_editor_menus.remove( draw_misc_top_level )
    bpy.types.CONSOLE_HT_header.remove( draw_misc_top_level )
